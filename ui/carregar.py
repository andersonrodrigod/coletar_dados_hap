...
from utils.loader import carregar_arquivo_json, criar_arquivo_cordenadas, criar_arquivo_processos, criar_arquivo_novo_dados, criar_arquivo_dados_analitics
...
class Carregar(ctk.CTkFrame):
    def __init__(self, parent, menu, app):
        ...
        self.label_info_inicial.grid(row=0, column=1, pady=15)
        ...
        self.btn_novo_arquivo.grid(row=2, column=1, pady=(10, 5))
